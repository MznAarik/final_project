    ...
    <div style="width: 48rem; margin-left: auto; margin-right: auto; background-color: #ffffff; padding: 2rem; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); border-radius: 0.5rem; position: relative; z-index: 1;">
        ...
        <form action="{{ route('events.store') }}" method="POST" enctype="multipart/form-data" style="margin-bottom: 1.5rem;">
            ...
            <div style="display: flex; gap: 1rem; margin-bottom: 1.5rem;">
                <div style="flex: 1;">
                   <label for="currency" 
                           style="display: block; font-weight: 600; margin-bottom: 0.25rem; color: #374151;">
                        Currency
                    </label>
                    
                    <!-- Disabled select for UI -->
                    <select id="currency" name="currency_disabled" disabled
                        style="width: 100%; border: 1px solid; 
                               @error('currency') border-color: #ef4444; @else border-color: #d1d5db; @enderror 
                               border-radius: 0.375rem; padding: 0.5rem 1rem; font-size: 1rem; transition: border-color 0.2s;">
